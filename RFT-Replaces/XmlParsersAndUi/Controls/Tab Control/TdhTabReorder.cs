...
namespace XmlParsersAndUi																				// 1.0.003
{																											// 1.0.003
	/// <summary>																							// 1.0.003
	...
	{																										// 1.0.003
		...
		private TdhTabCtl _theTabCtl = null;														// 1.0.003
		...
		//     TdhTabCtl theTabCtl, int activeTabPage_Idx, 
		...
		public TdhTabReorder(																				// 1.0.003
			TdhTabCtl theTabCtl, int activeTabPage_Idx,											// 1.0.003
		...
		{																									// 1.0.003
			...
			#endregion  
			TdhTabCtl.TabRect_DrawTabRect(														// 1.0.003

...
//   for the [TDHControls.TdhTabCtl] class,														// 1.0.020
...
{																											// 1.0.020
	...
	{																										// 1.0.020
		...
		{																									// 1.0.020
			XmlParsersAndUi.TdhTabCtl ParentControl = (XmlParsersAndUi.TdhTabCtl)this.Control;	// 1.0.020
			...
			XmlParsersAndUi.TdhTabPage newTab =														// 1.0.020
				(XmlParsersAndUi.TdhTabPage)DesignerHost.CreateComponent(								// 1.0.020
		...
		{																									// 1.0.020
			...
			{																								// 1.0.020
				...
				//
				//	TDHControls.TdhTabCtl ParentControl = (TDHControls.TdhTabCtl)this.Control;	// 1.0.020
...
//					TDHControls.TdhTabCtl ParentControl = (TDHControls.TdhTabCtl)this.Control;	// 1.0.021

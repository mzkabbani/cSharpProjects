...
namespace XmlParsersAndUi																				// 1.0.001
{																											// 1.0.001
	/// <summary>																							// 1.0.001
	...
	{																										// 1.0.001
		...
		private TdhTabCtl _owner = null;															// 1.0.001
		#endregion 

		#region Class Constructor (and Dispose)
		// 
		// public TdhTabPageCollection(TdhTabCtl owner) : base((System.Windows.Forms.TabControl)owner)
		// 
		// protected void Dispose( bool disposing )
		// 
		public TdhTabPageCollection(TdhTabCtl owner) : base((System.Windows.Forms.TabControl)owner)	// 1.0.001
		{																									// 1.0.001
...
{																								// 1.0.001
	_owner = owner;																				// 1.0.001
		...
		/// </summary>
		public new TdhTabPage this[int index]														// 1.0.001
		{																									// 1.0.001
			get																								// 1.0.001
			{																								// 1.0.001
				int idx = 0;																				// 1.0.001
				...
				if( (idx < 0)																				// 1.0.001
				||( (base[index].GetType() != typeof(TdhTabPage))									// 1.0.010
					&& !base[index].GetType().IsSubclassOf(typeof(TdhTabPage))					// 1.0.010
					)																						// 1.0.010
				)																							// 1.0.001
				{																							// 1.0.001
					return null;																			// 1.0.001
				}																							// 1.0.001
				return (base[idx] as TdhTabPage);													// 1.0.001
		...
		/// </summary>
		public TdhTabPage this[string text]														// 1.0.010
		{																									// 1.0.010
			get																								// 1.0.010
			{																								// 1.0.010
				...
				{																							// 1.0.010
					if( ((base[idx].GetType() == typeof(TdhTabPage))								// 1.0.010
						|| base[idx].GetType().IsSubclassOf(typeof(TdhTabPage))					// 1.0.010
						)																					// 1.0.010
					&& (base[idx].Text.Trim() == trimText)													// 1.0.010
					)																						// 1.0.010
					{																						// 1.0.010
						return (base[idx] as TdhTabPage);											// 1.0.010
		...
		public void AddRange(params TdhTabPage[] theTabPages)										// 1.0.001
		{																									// 1.0.001
			//_owner.cmnuTabRect_Built = false;																// 1.0.001
			//base.AddRange(theTabPages);																	// 1.0.001
			foreach (TdhTabPage _theTabPage in theTabPages)										// 1.0.001
			{																								// 1.0.001
		...
		public void InsertRange(int index, params TdhTabPage[] theTabPages)						// 1.0.004
		{																									// 1.0.004

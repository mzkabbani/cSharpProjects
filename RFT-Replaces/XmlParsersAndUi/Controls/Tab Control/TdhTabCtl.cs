...
using XmlParsersAndUi.TDHEditBox;																		// 1.0.001
#endregion 
...
namespace XmlParsersAndUi																				// 1.0.000
{
	...
	[System.ComponentModel.Designer(typeof(XmlParsersAndUi.TdhTabCtl_Designer))]						// 1.0.020 

	[System.ComponentModel.ToolboxItem(true)]																// 1.0.000
	[System.Drawing.ToolboxBitmapAttribute(typeof(TdhTabCtl), "TdhTabCtl.bmp")]					// 1.0.000
	...
	public class TdhTabCtl : System.Windows.Forms.TabControl												// 1.0.000
	{
		...
		private void InitializeComponent()
		{
			...
			this._TabPages = new TdhTabPageCollection(this);										// 1.0.001
		...
		public event XmlParsersAndUi.TabEventsDelegate OnTabEvents;									// 1.0.001

		[Category ("Action")]																				// 1.0.003
		[Description ("Occurs when the user Reorders the TdhTabPages of the TdhTabCtl control.")]			// 1.0.003
		public event XmlParsersAndUi.TabsReorderedEventDelegate OnTabsReordered;						// 1.0.003
		...
		private XmlParsersAndUi.TDHEditBox.TdhEditBox _tdhEditBox = null;								// 1.0.001
		...
		{																									// 1.0.003
			...
			{																								// 1.0.003
				TdhTabReorder frmReorder = new TdhTabReorder(							// 1.0.003
...
//		}																									// 1.0.002
		...
		private TdhTabPageCollection _TabPages = null;											// 1.0.001
...
[System.ComponentModel.DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]	// 1.0.001
		...
		public TdhTabPageCollection TdhTabPages													// 1.0.010
		{																									// 1.0.001
		...
		protected override void OnMouseDown(System.Windows.Forms.MouseEventArgs e)
		{
			...
			)
			{
				...
				{																							// 1.0.001
					...
					TdhTabPage theTabPage = this.TdhTabPages[this.cmnuTabRect_TabRect_Idx];		// 1.0.010
					TabPage_Close(theTabPage, this.cmnuTabRect_TabRect_Idx);								// 1.0.001
				}																							// 1.0.001
			}
			#endregion 
...
//[System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)]			// 1.0.001
		...
		{																									// 1.0.012
			...
			{																								// 1.0.012
				bool isTdhTabPage = (theTabPage.GetType() == typeof(TdhTabPage))					// 1.0.012
					|| theTabPage.GetType().IsSubclassOf(typeof(TdhTabPage));						// 1.0.012
				if (overridePermission																		// 1.0.012
				|| (isTdhTabPage																			// 1.0.012
					&& ((TdhTabPage)theTabPage).TabAllowClose)									// 1.0.012
				|| (!isTdhTabPage																			// 1.0.012
		...
		{																									// 1.0.012
			...
			if (overridePermission																			// 1.0.012
			|| (isTdhTabPage																				// 1.0.012
				&& ((TdhTabPage)theTabPage).TabAllowClose)										// 1.0.011
			|| (!isTdhTabPage																				// 1.0.012
				&& this._tabsBase_AllowClose)																// 1.0.011
			)																								// 1.0.011
			{																								// 1.0.001

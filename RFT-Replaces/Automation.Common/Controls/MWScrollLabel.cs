...
namespace Automation.Common
{
	...
	public class MWScrollLabel : System.Windows.Forms.Label
	{
		...
		{
			if(sfe == StringFormatEnum.GenericTypographic)
			{
				iTextPosMax = MWCommon.GetStringFormattedStringWidth(this, strfmt) + 2 - this.Width;
			}
			else
			{
                iTextPosMax = MWCommon.GetGraphicalStringWidth(this) + 2 - this.Width;
			}
		}

...
namespace Automation.Common
{
	...
	public class MWCheckBox : System.Windows.Forms.CheckBox
	{
		...
		private CheckBoxPaintOrder cbpoPaintOrder = CheckBoxPaintOrder.ImageCheckText;
		private TextDir tdTextDir = TextDir.Normal;
		...
		protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
		{
			if(this.FlatStyle != FlatStyle.System)
			{
				...
				{
					case CheckBoxPaintOrder.CheckImageText:
						PaintCheckBoxControl(e.Graphics);
						PaintImage(e.Graphics);
						PaintText(e.Graphics);
						break;

					case CheckBoxPaintOrder.CheckTextImage:
						PaintCheckBoxControl(e.Graphics);
						PaintText(e.Graphics);
						PaintImage(e.Graphics);
						break;

					case CheckBoxPaintOrder.ImageCheckText:
						PaintImage(e.Graphics);
						PaintCheckBoxControl(e.Graphics);
						PaintText(e.Graphics);
						break;

					case CheckBoxPaintOrder.ImageTextCheck:
						PaintImage(e.Graphics);
						PaintText(e.Graphics);
						PaintCheckBoxControl(e.Graphics);
						break;

					case CheckBoxPaintOrder.TextCheckImage:
						PaintText(e.Graphics);
						PaintCheckBoxControl(e.Graphics);
						PaintImage(e.Graphics);
						break;

					case CheckBoxPaintOrder.TextImageCheck:
						PaintText(e.Graphics);
						PaintImage(e.Graphics);
						PaintCheckBoxControl(e.Graphics);
						break;
		...
		private Rectangle GetModifiedClientRectangle(bool bTop)
		{
			...
			if(tdTextDir == TextDir.Normal || tdTextDir == TextDir.UpsideDown)
			{
		...
		private void SetStringFormat()
		{
			...
			if(sfe == StringFormatEnum.GenericDefault)
			{
		...
		DefaultValue(CheckBoxPaintOrder.ImageCheckText)
		]
		public CheckBoxPaintOrder CheckBoxPaintOrder
		{
			get
			{
		...
		public TextDir TextDir
		{
			...
			set
			{
				TextDir tdTextDirOld = tdTextDir;

				if(tdTextDir != value)
				{
					tdTextDir = value;
					OnTextDirChanged(new TextDirEventArgs(tdTextDirOld, tdTextDir));
					this.PaintAll();
				}
			}
		}
		...
		public StringFormatEnum StringFrmt
		{
			...
			set
			{
				StringFormatEnum sfeOld = sfe;
				if(sfe != value)
				{
					sfe = value;
					OnStringFrmtChanged(new StringFormatEnumEventArgs(sfeOld, sfe));
		...
		public event StringFormatEnumEventHandler StringFrmtChanged;

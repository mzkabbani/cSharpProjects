...
namespace TDHControls.TDHTabCtl																				// 1.0.005
{																											// 1.0.005
	#region Define EventHandler Delegates Class/Control

	// Enable the [TDHControls.TDHTabCtl.TdhTabCtl] instance to notify the client-code of:					// 1.0.000
	// . TdhTabPage-AddEvent																				// 1.0.001
	// . TdhTabPage-RemoveEvent																				// 1.0.000
	// . TdhTabPage-RenameEvent																				// 1.0.001
	public delegate void TabEventsDelegate(object sender, TDHControls.TDHTabCtl.TabEventArgs e);			// 1.0.001

	// . TdhTabPage-ReorderEvent																			// 1.0.003
	public delegate void TabsReorderedEventDelegate(object sender, TDHControls.TDHTabCtl.TabsReorderedEventArgs e);	// 1.0.003
	...
	public class TabEventArgs : System.EventArgs															// 1.0.001
	{
		...
		protected TDHTabCtl.TabEventArgs.TabEvents _TabEvent = TDHTabCtl.TabEventArgs.TabEvents.undefined;	// 1.0.001
		...
		{																									// 1.0.010
			...
			{																								// 1.0.010
				...
				&&( (this._TabPage.GetType() == typeof(TDHTabCtl.TdhTabPage))								// 1.0.010
					|| this._TabPage.GetType().IsSubclassOf(typeof(TDHTabCtl.TdhTabPage))					// 1.0.010
					)																						// 1.0.010
				)																							// 1.0.010
				{																							// 1.0.010
					return true;																			// 1.0.010
		...
		public TDHTabCtl.TdhTabPage TdhTabPage																// 1.0.010
		{																									// 1.0.010
			get																								// 1.0.010
			{																								// 1.0.010
				if( (this._TabPage != null)																	// 1.0.010
				...
				{																							// 1.0.010
					return (TDHTabCtl.TdhTabPage)this._TabPage;												// 1.0.010
				}																							// 1.0.010
				return null;																				// 1.0.010
			}																								// 1.0.010
		}																									// 1.0.010
		...
		public TDHTabCtl.TabEventArgs.TabEvents TabEvent													// 1.0.001
		{																									// 1.0.001
	...
	#region Class:  TabsReorderedEventArgs : TDHTabCtl.TabEventArgs
	public class TabsReorderedEventArgs : TDHTabCtl.TabEventArgs											// 1.0.003
	{
		...
		public TabsReorderedEventArgs()																		// 1.0.003
			: base(-1, -1, null, TDHTabCtl.TabEventArgs.TabEvents.TabsReordered)							// 1.0.003
		{																									// 1.0.003
		}																									// 1.0.003

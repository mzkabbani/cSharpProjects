...
namespace TDHControls.TDHTabCtl.TDHEditBox																	// 1.0.001
{																											// 1.0.001
	...
	internal class TdhEditBox : System.ComponentModel.Component												// 1.0.001
	{
		...
		public event TDHControls.TDHTabCtl.TDHEditBox.EditComplete OnEditComplete;							// 1.0.001
		...
		{																									// 1.0.003
			...
			{																								// 1.0.001
				this._frmEditBox = new TDHEditBox.frmEditBox(												// 1.0.001
					new TDHControls.TDHTabCtl.TDHEditBox.EditComplete(this.EditComplete)					// 1.0.001
					);																						// 1.0.001
			}																								// 1.0.001
			#endregion 
...
//}																									// 1.0.001
	...
	public delegate void EditComplete(object sender, TDHControls.TDHTabCtl.TDHEditBox.EditEventArgs editArgs);	// 1.0.001
